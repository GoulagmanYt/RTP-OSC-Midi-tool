...
impl MidiPacketHeaderFlags {
    ...
    fn set_version(&mut self, version: u8) {
        self.flags
            .set((self.flags.get() & !(FlagMasks::Version as u16)) | ((version as u16) << 14));
    }
    ...
    fn set_cc(&mut self, cc: u8) {
        self.flags
            .set((self.flags.get() & !(FlagMasks::CC as u16)) | ((cc as u16) << 8));
    }
    ...
    fn set_pt(&mut self, pt: u8) {
        self.flags
            .set((self.flags.get() & !(FlagMasks::PT as u16)) | (pt as u16));
    }
}

impl From<u16> for MidiPacketHeaderFlags {
    fn from(flags: u16) -> Self {
        MidiPacketHeaderFlags {
            flags: U16::new(flags),
        }
    }
}
