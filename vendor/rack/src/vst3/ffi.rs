...
extern "C" {
    ...
    pub fn rack_vst3_plugin_editor_size(
        plugin: *mut RackVST3Plugin,
        width: *mut f32,
        height: *mut f32,
    ) -> c_int;

    pub fn rack_vst3_plugin_create_gui(plugin: *mut RackVST3Plugin) -> *mut RackVST3Gui;

    pub fn rack_vst3_gui_free(gui: *mut RackVST3Gui);

    pub fn rack_vst3_gui_attach(gui: *mut RackVST3Gui, parent: *mut std::ffi::c_void) -> c_int;

    pub fn rack_vst3_gui_detach(gui: *mut RackVST3Gui) -> c_int;
